...
def display(request):
    ...
    if (abs(choice-int(ele1.floor_status)) > abs(choice-int(ele2.floor_status))) and ele1.status=='available':
        while True:
            ele1.start()
            params={'floor':num_floors,'elevator':num_elevators,'name':ele1.name,'status':ele1.status,'work':ele1.work, 'vfloor':ele1.floor_status,'name2':ele2.elevator,'status2':ele2.status,'work2':ele2.work, 'vfloor2':ele2.floor_status}
            render(request,"status copy.html",params)
            time.sleep(1)
            if fnum>ele1.floor_status:
                ele1.up()
            else:
                ele1.down()
            params={'floor':num_floors,'elevator':num_elevators,'name':ele1.name,'status':ele1.status,'work':ele1.work, 'vfloor':ele1.floor_status,'name2':ele2.name,'status2':ele2.status,'work2':ele2.work, 'vfloor2':ele2.floor_status}
    ...
    elif (abs(choice-ele1.floor_status) < abs(choice-ele2.floor_status)) and ele2.status=='available':
        while True:
            ele2.start()
            params={'floor':num_floors,'elevator':num_elevators,'name':ele1.name,'status':ele1.status,'work':ele1.work, 'vfloor':ele1.floor_status,'name2':ele2.name,'status2':ele2.status,'work2':ele2.work, 'vfloor2':ele2.floor_status}
            render(request,"status copy.html",params)
            time.sleep(1)
            if fnum>ele2.floor_status:
                ele2.up()
            else:
                ele2.down()
            params={'floor':num_floors,'elevator':num_elevators,'name':ele1.name,'status':ele1.status,'work':ele1.work, 'vfloor':ele1.floor_status,'name2':ele2.name,'status2':ele2.status,'work2':ele2.work, 'vfloor2':ele2.floor_status}
